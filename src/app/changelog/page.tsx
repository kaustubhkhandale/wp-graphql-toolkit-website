...
export const metadata: Metadata = {
  ...
  description: "Release notes for KGraph Headless Toolkit for WPGraphQL through version 1.1.4.",
};

export default function ChangelogPage() {
  return <ContentPage><PageHero eyebrow="Changelog" title="What is new in KGraph Headless Toolkit for WPGraphQL." intro="A complete record of plugin improvements and fixes through the latest release." actions={[
    { href: "/download-plugin/kgraph-headless-toolkit-1.1.4.zip", label: "Download version 1.1.4" },
  ]} />
    <Article notice="Latest release: version 1.1.4, published June 11, 2026." sections={[
      ...
      { title: "1.0.0 - Initial Development Release", bullets: ["Published the initial development release of KGraph Headless Toolkit for WPGraphQL."] },
    ]} />
  </ContentPage>;
}
